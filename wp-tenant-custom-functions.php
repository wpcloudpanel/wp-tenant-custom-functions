...
Description: A WordPress plugin that handles support functions needed for templates deployed by multi-tenant service providers such as opensaas.io & WPCloudDeploy.
Version: 1.0.0
Item Id:
...
class WP_Tenant_Custom_Functions_Init {
	...
	public function add_dashboard_widgets() {
		...
		wp_add_dashboard_widget( 'wpmt_checklist', 'OpenSaaS Setup Checklist', array( $this, 'wpmt_add_checklist_wpadmin_widget' ), null, null, 'column3', 'high' );
	}
